...
if "auth" not in st.session_state:
    ...
    with col_log:
        ...
        u_in = st.text_input(LANGS[sel_lang]["ident"])
        p_in = st.text_input(LANGS[sel_lang]["pass"], type="password")
        if st.button(LANGS[sel_lang]["btn_log"], use_container_width=True):
